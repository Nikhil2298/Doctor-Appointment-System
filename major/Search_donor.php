...
<script type="text/javascript">
  ...
  function checkForm(form)
  {
      if(form.blood_group.value == "") {
        alert("Error: choose a blood group!");
...
<center>
<img src ="photos/search_donor_image.png" alt="Search donor">
<form action="" method ="post" onsubmit="return checkForm(this);">
<h2 class="lable">Search Blood Donor</h2>
<br>
...
<br>
<br>
<label class="lable">Blood Group :</label>&nbsp&nbsp
...
<?php
	...
	if(isset($_POST['search']))
	{
		...
		$sql= "select * from donor where city='$city' && blood_group='$blood'";
		//echo $sql; die;
		$count =1;
