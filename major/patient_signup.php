<?php 
	...
	if(isset($_POST['submit']))
	{
		...
		$sql = "insert into patient_detail set patient_name='$name', age='$age', gender='$gender',blood_group='$blood', city='$city', address='$address', contact_no='$contact', email='$email', user_id='$username', password='$password'";
		//echo $sql; die;
...
<header>
	...
	<div class="container transparentform">
        ...
        <div id="login">
			<center><h2>Patient Signup</h2></center>
          <form action="patient_signup.php" method="post" onsubmit="return checkForm(this);">
         ...
         <div class="field-wrap">
		  <h3 class="lable">Age</h3>
            <input class="wid" type="number" max="85" min="2" required placeholder="Enter Your Age" autocomplete="off" name="age"/>
          </div>
		  <div class="field-wrap">
