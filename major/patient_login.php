...
<header>
			...
			if(isset($_POST['Login']))
	{
		...
		$sql="select patient_id from patient_detail where user_id='$username' and password='$password'";
		//echo $sql; die;
		...
		if($count>0)
		{
		  ...
		  <a href="patient_signup.php"><h3 class="lable">Patient Registration</h3></a>
