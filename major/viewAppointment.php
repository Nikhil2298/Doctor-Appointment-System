<?php
	...
	session_start();
	$pID=$_SESSION['id'];
	$sql="SELECT doctor_name,contact_no,address,email,date,time,status FROM appointment JOIN doctor_detail ON appointment.doctor_id = doctor_detail.doctor_id where patient_id='$pID'";
